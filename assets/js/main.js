...
/***/ function(module, exports) {
	...
	var Comic = function Comic(comicNode) {
	    ...
	    var prevPageNodeList = document.querySelectorAll('.js-comic-prev-page');
	    var nextPageNodeList = document.querySelectorAll('.js-comic-next-page');
	
	    var prevIssueNodeList = document.querySelectorAll('.js-comic-prev-issue');
	    var nextIssueNodeList = document.querySelectorAll('.js-comic-next-issue');
	    ...
	    var updatePage = function updatePage() {
	        ...
	        for (var i = 0; i < comicPageNodeList.length; i++) {
	...
	var shareFacebookNode = document.querySelector('.js-share-facebook');
	...
	var shareTwitterNode = document.querySelector('.js-share-twitter');
